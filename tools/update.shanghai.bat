...
cd %~dp0
::compile
for %%f in (RcuClear RcuMode RcuOpera RcuOrder RcuPoll) do call .\scripts\update1.bat %%f
...
for %%f in (RcuClear RcuOrder RcuPoll) do call .\scripts\update2.bat %%f ..\RcuService\RcuAll\lib\RcuAll.jar
